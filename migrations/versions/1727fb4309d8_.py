...
def upgrade():
    ...
    op.alter_column('account', 's3_name', type_=sa.VARCHAR(
        64), existing_type=sa.VARCHAR(length=32), nullable=True)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('account', 's3_name', type_=sa.VARCHAR(
        32), existing_type=sa.VARCHAR(length=64), nullable=True)
    ### end Alembic commands ###
