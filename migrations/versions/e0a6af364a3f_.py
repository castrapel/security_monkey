...
def upgrade():
    ...
    op.create_table('cloudtrail',
                    ...
                    sa.Column('request_parameters',
                              postgresql.JSON(), nullable=True),
                    sa.Column('responseElements',
                              postgresql.JSON(), nullable=True),
                    ...
                    sa.Column('user_identity',
                              postgresql.JSON(), nullable=True),
                    sa.Column('user_identity_arn', sa.String(
                        length=300), nullable=True),
                    sa.Column('revision_id', sa.Integer(), nullable=False),
                    sa.Column('item_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['item_id'], ['item.id'], ),
                    sa.ForeignKeyConstraint(
                        ['revision_id'], ['itemrevision.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index('ix_cloudtrail_event_id', 'cloudtrail',
                    ['event_id'], unique=True)
    op.create_index('ix_cloudtrail_event_time', 'cloudtrail',
                    ['event_time'], unique=False)
    op.create_index('ix_cloudtrail_item_id', 'cloudtrail',
                    ['item_id'], unique=False)
    op.create_index('ix_cloudtrail_request_id', 'cloudtrail',
                    ['request_id'], unique=False)
    op.create_index('ix_cloudtrail_revision_id', 'cloudtrail',
                    ['revision_id'], unique=False)
    op.create_index('ix_cloudtrail_user_identity_arn', 'cloudtrail', [
                    'user_identity_arn'], unique=False)
    op.create_index('ix_auditorsettings_account_id',
                    'auditorsettings', ['account_id'], unique=False)
    op.create_index('ix_auditorsettings_tech_id',
                    'auditorsettings', ['tech_id'], unique=False)
    op.create_index('ix_ignorelist_tech_id', 'ignorelist',
    ...
    op.create_index('ix_itemaudit_auditor_setting_id', 'itemaudit', [
                    'auditor_setting_id'], unique=False)
    op.create_index('ix_itemaudit_item_id', 'itemaudit',
                    ['item_id'], unique=False)
    op.create_index('ix_itemaudit_justified_user_id', 'itemaudit', [
                    'justified_user_id'], unique=False)
    op.create_index('ix_itemcomment_item_id', 'itemcomment',
                    ['item_id'], unique=False)
    op.create_index('ix_itemcomment_user_id', 'itemcomment',
                    ['user_id'], unique=False)
    op.create_index('ix_itemrevision_item_id',
                    'itemrevision', ['item_id'], unique=False)
    op.create_index('ix_itemrevisioncomment_revision_id',
                    'itemrevisioncomment', ['revision_id'], unique=False)
    op.create_index('ix_itemrevisioncomment_user_id',
                    'itemrevisioncomment', ['user_id'], unique=False)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_itemrevisioncomment_user_id',
                  table_name='itemrevisioncomment')
    op.drop_index('ix_itemrevisioncomment_revision_id',
                  table_name='itemrevisioncomment')
    ...
    op.drop_index('ix_auditorsettings_account_id',
                  table_name='auditorsettings')
