...
class ResourcePolicyTestCase(SecurityMonkeyTestCase):
    ...
    def pre_test_setup(self):
        ...
        datastore.store('iamuser', 'us-east-1', 'TEST_ACCOUNT', 'my-test-iam-user',
                        True, dict(UserId='AIDA11111111111111111',
                                   UserName='my-test-iam-user'),
        ...
        datastore.store('iamuser', 'us-east-1', 'TEST_ACCOUNT_TWO', 'my-test-iam-user-two',
                        True, dict(UserId='AIDA22222222222222222',
                                   UserName='my-test-iam-user-two'),
        ...
        datastore.store('iamrole', 'us-east-1', 'TEST_ACCOUNT_TWO', 'my-test-iam-role-two',
                        True, dict(RoleId='AISA22222222222222222',
        ...
        datastore.store('iamrole', 'us-east-1', 'TEST_ACCOUNT_THREE', 'my-test-iam-role-three',
                        True, dict(RoleId='AISA33333333333333333',
        ...
        datastore.store('natgateway', 'us-east-1', 'TEST_ACCOUNT', 'my-test-natgateway',
                        True, dict(nat_gateway_addresses=[
    ...
    def test_load_policies(self):
        ...
        policies = [
            policy.policy for policy in rpa.load_resource_policies(test_item)]
        ...
        rpa.policy_keys = ['Policies$Aliases$*',
                           'Policies$DEFAULT', 'Policies$Versions$*']
        policies = [
            policy.policy for policy in rpa.load_resource_policies(test_item)]
    ...
    def test_prep_for_audit(self):
        ...
        self.assertEqual(
            rpa.OBJECT_STORE['s3']['my-test-s3-bucket'], set(['012345678910']))
        self.assertEqual(rpa.OBJECT_STORE['ACCOUNTS']['FRIENDLY'], set(
            ['012345678910', '222222222222']))
        self.assertEqual(
            rpa.OBJECT_STORE['ACCOUNTS']['THIRDPARTY'], set(['333333333333']))
    ...
    def test_inspect_entity(self):
        ...
        for who in policy.whos_allowed():
            ...
            self.assertEqual(
                set(['SAME']), rpa.inspect_entity(entity, test_item))
    ...
    def test_check_internet_accessible(self):
        ...
        rpa.add_issue = lambda *args, **kwargs: mock_add_issue_two(
            *args, **kwargs)
        rpa.check_internet_accessible(test_item)
    ...
    def test_check_friendly_cross_account(self):
        ...
        def mock_add_issue(score, issue, item, notes=None):
            ...
            self.assertEqual(
                'Account: [222222222222/TEST_ACCOUNT_TWO] Entity: [principal:arn:aws:iam::222222222222:root] Actions: ["ec2:*"]',
                notes)
    ...
    def test_check_unknown_cross_account(self):
        ...
        def mock_add_issue(score, issue, item, notes=None):
            ...
            self.assertEqual(
                'Entity: [principal:arn:aws:iam::444444444444:root] Actions: ["ec2:*"]', notes)
