...
class RDSSnapshotAuditorTestCase(SecurityMonkeyTestCase):
    ...
    def test_check_internet_accessible(self):
        ...
        self.assertEquals(
            item.audit_issues[0].notes, 'Entity: [account:all] Actions: ["restore"]')
    ...
    def test_check_friendly(self):
        ...
        self.assertEquals(
            ...
            'Account: [222222222222/TEST_ACCOUNT_TWO] Entity: [account:222222222222] Actions: ["restore"]')
    ...
    def test_check_thirdparty(self):
        ...
        self.assertEquals(item.audit_issues[0].score, 0)
        self.assertEquals(
            item.audit_issues[0].issue, 'Thirdparty Cross Account')
        self.assertEquals(
            item.audit_issues[0].notes,
            'Account: [333333333333/TEST_ACCOUNT_THREE] Entity: [account:333333333333] Actions: ["restore"]')
