...
decoded_id_token = {u'nonce': u'd9cf2561563e4ec3bc18ea3373bad543', u'family_name': u'Leaniz',
                    u'sub': u'ISSDOLYIFn5GPZBN0S6PfdBx-haA2KVK4lLZbci3C-s', u'c_hash': u'y_9iMybdDKd7iEN4w_14iw',
                    u'aud': u'8d24cc89-0f6c-44aa-82c4-xxxxxxxx',
                    u'iss': u'https://sts.windows.net/6a1af301-b747-43c1-80ac-xxxxxxxx/',
                    u'oid': u'5b32bcc6-b57d-4914-9074-2c8a17c18abe', u'ipaddr': u'10.11.11.1',
                    u'unique_name': u'juan.leaniz_ubisoft.com#EXT#@ubisoftsrm.onmicrosoft.com',
                    u'idp': u'https://sts.windows.net/e01bd386-fa51-4210-a2a4-xxxx/',
                    u'email': u'juan.leaniz_ubisoft.com#EXT#@ubisoftsrm.onmicrosoft.com',
                    u'aio': u'ATQAy/8EAAAAFhmfvc4rjeMQ3f2xFN0/g0+ea8ss3n9mUH/xT9HDtA6qsIt84FFK1h7gNRSaJz4S',
                    u'given_name': u'Juan', u'exp': 1504811806, u'in_corp': u'true',
                    u'tid': u'6a1af301-b747-43c1-80ac-4e944b56b779', u'iat': 1504807906, u'amr': [u'wia'],
                    u'nbf': 1504807906, u'ver': u'1.0', u'name': u'Juan Leaniz'}
...
class AzureADTestCase(SecurityMonkeyTestCase):
    def test_azure_post(self):
        aad = AzureAD()
        (test_secret, test_algo) = aad.get_idp_cert(
            encoded_id_token, TEST_CONFIG['jwksUrl'])
        self.assertEqual(secret, test_secret)
        test_username = aad.validate_id_token(
            encoded_id_token, TEST_CONFIG['clientID'], TEST_CONFIG['jwksUrl'])
