...
ENVIRONMENT = 'ec2'
USE_ROUTE53 = False
FQDN = os.getenv('SECURITY_MONKEY_FQDN',
...
SECRET_KEY = os.getenv('SECURITY_MONKEY_SECRET_KEY',
                       '<INSERT_RANDOM_STRING_HERE>')

MAIL_DEFAULT_SENDER = os.getenv(
    'SECURITY_MONKEY_EMAIL_DEFAULT_SENDER', 'securitymonkey@example.com')
SECURITY_REGISTERABLE = env_to_bool(
    os.getenv('SECURITY_MONKEY_SECURITY_REGISTERABLE', False))
SECURITY_CONFIRMABLE = env_to_bool(
    os.getenv('SECURITY_MONKEY_SECURITY_CONFIRMABLE', False))
SECURITY_RECOVERABLE = env_to_bool(
    os.getenv('SECURITY_MONKEY_SECURITY_RECOVERABLE', False))
SECURITY_PASSWORD_HASH = 'bcrypt'
SECURITY_PASSWORD_SALT = os.getenv(
    'SECURITY_MONKEY_SECURITY_PASSWORD_SALT', '<INSERT_RANDOM_STRING_HERE>')
...
EMAIL_AUDIT_REPORTS_INCLUDE_JUSTIFIED = env_to_bool(
    os.getenv('SECURITY_MONKEY_EMAIL_AUDIT_REPORTS_INCLUDE_JUSTIFIED', True))

# These are only required if using SMTP instead of SES
EMAILS_USE_SMTP = env_to_bool(
    os.getenv('SECURITY_MONKEY_SMTP', True))     # Otherwise, Use SES
...
ONELOGIN_IDP_CERT = os.getenv(
    'SECURITY_MONKEY_ONELOGIN_IDP_CERT', '<IDP_CERT>')
ONELOGIN_USE_CUSTOM = os.getenv('SECURITY_MONKEY_ONELOGIN_USE_CUSTOM', False)
if not ONELOGIN_USE_CUSTOM:
    ONELOGIN_ENTITY_ID = "https://app.onelogin.com/saml/metadata/{APP_ID}".format(
        APP_ID=ONELOGIN_APP_ID)
    ONELOGIN_SSO_URL = "https://app.onelogin.com/trust/saml2/http-post/sso/{APP_ID}".format(
        APP_ID=ONELOGIN_APP_ID)
    ONELOGIN_SLO_URL = "https://app.onelogin.com/trust/saml2/http-redirect/slo/{APP_ID}".format(
        APP_ID=ONELOGIN_APP_ID)
else:
...
USE_HEADER_AUTH = env_to_bool(
    os.getenv("SECURITY_MONKEY_USE_HEADER_AUTH", False))
HEADER_AUTH_USERNAME_HEADER = os.getenv(
    "SECURITY_MONKEY_HEADER_AUTH_USERNAME_HEADER", "Remote-User")
HEADER_AUTH_GROUPS_HEADER = os.getenv(
    "SECURITY_MONKEY_HEADER_AUTH_GROUPS_HEADER")
